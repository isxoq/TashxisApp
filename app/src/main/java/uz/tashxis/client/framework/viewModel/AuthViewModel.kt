...
import uz.tashxis.client.business.util.*
...
class AuthViewModel(
    ...
    override fun setImageUri(uri: String) {
        ...
        Toast.makeText(uz.tashxis.client.App.context!!, "AuthViewModelda ishlavatti $uri", Toast.LENGTH_SHORT).show()
    }
                ...
                if (result.isSuccessful) {
                    when (result.body()!!.code) {
                        BaseDomen.SUCCESS -> {
                            ...
                            logReg.postValue(uz.tashxis.client.business.util.Constants.REG)
                        }
...
//                                preference ga mashetta saqlab qo'ya qolamiz'
                ...
                if (result.isSuccessful) {
                    when (result.body()!!.code) {
                        BaseDomen.SUCCESS -> {
                            ...
                            phoneNumber.postValue(phone)
                            logReg.postValue(uz.tashxis.client.business.util.Constants.LOG)
    ...
    override fun setPreferences(data: Any) {
        if (data is LoginVerifyData) {
            ...
            if (data.gender == 1) {
                preferences.gender ="Erkak"
            } else {
                preferences.gender = "Ayol"
            }
