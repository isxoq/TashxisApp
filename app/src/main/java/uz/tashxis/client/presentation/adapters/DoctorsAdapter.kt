...
import uz.tashxis.client.databinding.ItemDoctorsLayoutBinding
...
class DoctorsAdapter :
    ...
    class DoctorsVH(
        ...
        fun onBind(model: DoctorResponseData) {
            ...
            binding.tvQabulPrice.text =
                itemView.context.getString(R.string.price, model.acceptanceAmount.toString())
            binding.tvDistanceDoctor.text =
                itemView.context.getString(R.string.distance, model.distance.toString())
            binding.tvStarCount.text = model.rate.toString()
            binding.tvCommentDoctor.text =
                itemView.context.getString(R.string.string_comment, model.id.toString())
